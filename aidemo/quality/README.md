# Improving the quality of an OpenAPI document using Generative AI

Example of use cases:
- define what means complete and get information if the document is complete
- identify gaps with provided OpenAPI documents
- identify incomplete or incorrect documentation descriptions and summaries
- identify inconsistent summaries and descriptions
